...
public class AutomaticWiringParamsH2Impl implements AutomaticWiringParams {
    ...
    private boolean m2(ContextManager contextManager, java.lang.reflect.Parameter[] parameters) {
    ...
    private void m1(List results, java.lang.reflect.Parameter[] parameters, Object[] ros, int i) {
    ...
    private void m0(Object[] objects, java.lang.reflect.Parameter parameter, Object[] ros, List<Object> list, int i) {
