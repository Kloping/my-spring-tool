...
public interface PvpQq {
    ...
    PvpQQVoice get0(@ParamName("callback") @DefaultValue("createList") String createList);

    @GetPath("webplat/info/news_version3/15592/18024/23901/24397/24398/m22352/index.shtml?callback=createHeroList")
    @Callback("test.Simple.c1")
    PvpQQH0 get1(@ParamName("callback") @DefaultValue("createHeroList") String createHeroList);
